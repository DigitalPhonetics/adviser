...
from modules.nlg.templates.data.expressions.variableexpression import VariableExpression
from modules.nlg.templates.parsing.parsers.codeparser.data.functiondeclaration import FunctionDeclaration
from modules.nlg.templates.parsing.parsers.codeparser.states.statelist import VariableState, \
