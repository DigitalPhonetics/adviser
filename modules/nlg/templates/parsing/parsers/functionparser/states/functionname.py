...
from modules.nlg.templates.parsing.parsers.functionparser.states.statelist import \
    FunctionNameState, ArgumentStartState
from modules.nlg.templates.parsing.parsers.functionparser.data.function import FunctionDeclaration
