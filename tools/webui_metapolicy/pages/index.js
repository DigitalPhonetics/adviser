...
class Index extends Component {
  ...
  render = () => (
    <div className='hsplit'>
      ...
      <div className="right">
        {
          this.state.showDebugView && <TurnInfoList turnInfo={this.state.turnInfo.ImsCourses}/>
        }
      </div>
      <div className="rightright">
        {
          this.state.showDebugView && <TurnInfoList turnInfo={this.state.turnInfo.ImsLecturers}/>
        }
      </div>
      {
