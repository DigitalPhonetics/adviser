...
if __name__ == '__main__':
    domain = JSONLookupDomain('ImsLecturers', os.path.join('resources', 'databases', 'ImsLecturers-rules.json'), 
                              os.path.join('resources', 'databases', 'ImsLecturersConfidential-dbase.db'))
    regex_file = RegexFile('/home/mo/Job/ADvISER/diasys/adviser/resources/regexes/ImsLecturers.nlu', domain)
