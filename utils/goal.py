...
import copy
from utils import common, logger, UserAct, UserActionType
...
class Goal(object):
    ...
    def init(self, random_goal=True, constraints=None, requests=None):
        ...
        self.missing_informs = [UserAct(act_type=UserActionType.Inform, slot=_constraint.slot, value=_constraint.value) for _constraint in self.constraints]
