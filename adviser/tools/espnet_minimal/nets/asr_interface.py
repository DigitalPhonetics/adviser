...
from tools.espnet_minimal.bin.asr_train import get_parser
from tools.espnet_minimal.utils.dynamic_import import dynamic_import
...
predefined_asr = {
    "pytorch": {
        "rnn": "services.hci.speech.espnet_minimal.nets.pytorch_backend.e2e_asr:E2E",
        "transformer": "services.hci.speech.espnet_minimal.nets.pytorch_backend.e2e_asr_transformer:E2E",
    },
    "chainer": {
        "rnn": "services.hci.speech.espnet_minimal.nets.chainer_backend.e2e_asr:E2E",
        "transformer": "services.hci.speech.espnet_minimal.nets.chainer_backend.e2e_asr_transformer:E2E",
    }
}
