...
from tools.espnet_minimal.nets.pytorch_backend.e2e_tts_tacotron2 import Tacotron2
from tools.espnet_minimal.nets.pytorch_backend.e2e_tts_transformer import Transformer
